...
$GLOBALS['CONF']['TongDun_Web_Secret_Key'] = '48118ad00dab4f0ba98a5e8d12d133f2';//！！！未更新，同盾未分配！！！
...
$GLOBALS['CONF']['WECHAT'] = [
    ...
    'TOKEN'     => 'FumZTt0f4UBR7VkpeNz1av3jrIGKWw',//Token(令牌)
    'AESKEY'    => 'kTuPY6CEdEkHV4NkEgXd5wUbMF63FR3Cts25ZPacbRx',//EncodingAESKey(消息加解密密钥)
];
