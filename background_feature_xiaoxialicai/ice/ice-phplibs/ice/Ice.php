...
require_once __DIR__.'/Ice/Connection.php';
require_once __DIR__.'/Ice/EndpointTypes.php';
require_once __DIR__.'/Ice/LocalException.php';
require_once __DIR__.'/Ice/Locator.php';
require_once __DIR__.'/Ice/ObjectFactory.php';
require_once __DIR__.'/Ice/Process.php';
require_once __DIR__.'/Ice/Router.php';
require_once __DIR__.'/Ice/Version.php';
require_once __DIR__.'/Ice/Instrumentation.php';
require_once __DIR__.'/Ice/Metrics.php';
require_once __DIR__.'/Ice/RemoteLogger.php';
