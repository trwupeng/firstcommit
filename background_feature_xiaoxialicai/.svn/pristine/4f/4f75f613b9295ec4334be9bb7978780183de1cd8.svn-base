...
class PayCK {
    ...
    public function dayInterest($ymd)
    {
        ...
        if($this->rpc!==null){
            ...
            switch ($rand){
                case 1: 	return [
                    ['file'=>'sina/'.$ymd.'/dayRecharges.csv','ymd'=>$ymd,'SN'=>time().rand(1000,9999),'userId'=>'90003837339748','amount'=>0,'paycorp'=>'101'],
                    ['file'=>'sina/'.$ymd.'/dayRecharges.csv','ymd'=>$ymd,'SN'=>time().rand(1000,9999),'userId'=>'90003837339750','amount'=>0,'paycorp'=>'101'],
                    ['file'=>'sina/'.$ymd.'/dayRecharges.csv','ymd'=>$ymd,'SN'=>time().rand(1000,9999),'userId'=>'90003837339748','amount'=>0,'paycorp'=>'101'],
                    ['file'=>'sina/'.$ymd.'/dayRecharges.csv','ymd'=>$ymd,'SN'=>time().rand(1000,9999),'userId'=>'90003837339748','amount'=>0,'paycorp'=>'101'],
