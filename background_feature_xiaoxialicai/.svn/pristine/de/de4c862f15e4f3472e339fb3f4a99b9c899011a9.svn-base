...
namespace PrjCronds;
/**
 * php /var/www/licai_php/run/crond.php "__=crond/rungrab&task=RptDaily.EDStocking&ymdh=20160126"
 *
 * Created by PhpStorm.
 * User: li.lianqi
 * Date: 2016/1/26 0026
...
error_log('apply withdraw add:'.$applyWithdrawDay->totalAdd);
    ...
    protected function sqlBase ($where) {
        return 'select sum(tb_recharges_final.amount)/100 as n,tb_user_final.copartnerId '
