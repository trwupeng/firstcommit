...
class SOOH_REQEST_INFO{
	public $_COOKIE_Original;
	public $_REQUEST;
	public $_COOKIE_Final;
	public $_DUR_MS;
	public $_RESPONSE;
}
$_SOOH_REQUEST_INFO = new SOOH_REQEST_INFO;
$_SOOH_REQUEST_INFO->_REQUEST = $_REQUEST;
$_SOOH_REQUEST_INFO->_COOKIE_Original = $_COOKIE;
$_SOOH_REQUEST_INFO->_DUR_MS = microtime(true);
...
if($_COOKIE['SoohSessId']=='imei:null'||$_COOKIE['SoohSessId']=='imei:000000000000000'||$_COOKIE['SoohSessId']=='imei:111111111111111'){
	$newCookiePre = "imei";
	$_COOKIE['SoohSessId']='';
...
if($response){
	$response->response();
	$_SOOH_REQUEST_INFO->_RESPONSE = ob_get_contents();
	ob_flush();
}
$_SOOH_REQUEST_INFO->_COOKIE_Final = $_COOKIE;
$_SOOH_REQUEST_INFO->_DUR_MS = sprintf("%.2f",microtime(true)-$_SOOH_REQUEST_INFO->_DUR_MS);
