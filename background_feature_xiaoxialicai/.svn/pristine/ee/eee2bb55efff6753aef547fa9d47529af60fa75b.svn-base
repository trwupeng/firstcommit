...
class OauthController extends \Prj\BaseCtrl
{
    ...
    public function validForRegAction()
    {
        ...
        $rules  = [
            ...
            'inviteCode'   => [
                inputValidation::$define['invitationCode'],
                \Prj\Lang\Broker::getMsg('oauth.inviteCode_is_not_valid')
            ],
            'clientId'     => [
                inputValidation::$define['clientId'],
                $this->oauthResponse->invalid_request_client_id['error'],
    ...
    public function sendInvalidcodeAction()
    {
        ...
        if (inputValidation::validateParams($params, [
                'phone' => [
                    inputValidation::$define['phone'],
                    \Prj\Lang\Broker::getMsg('passport.phone_number_is_not_valid')
                ]
        ...
        try {
            ...
            if ($dbLogin->exists()) {
                ...
                $_sess->set('sendInvalidCodeForRegisterLastTime', $_nowTime);
    ...
    public function resetPwdAction()
    {
        ...
        $rules = [
            'phone'        => [
                inputValidation::$define['phone'],
                \Prj\Lang\Broker::getMsg('account.account_or_password_input_error')
            ],
            'invalidCode'  => [
                inputValidation::$define['smscode'],
                \Prj\Lang\Broker::getMsg('passport.smscode_is_not_valid')
