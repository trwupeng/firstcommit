...
class Agreement2Controller extends \Prj\ManagerCtrl {
    ...
    public function indexAction() {
        ...
        $pager->init(-1, $pageId);
        $records = \Prj\Data\Agreement2::paged($pager, $where, null, implode(',', array_keys($fieldsMapArr)));
...
//		}
    ...
    public function editAction() {
        ...
        if ($frm->type() == \Sooh\Base\Form\Broker::type_c) {
            ...
            $obj = \Prj\Data\Agreement2::getCopy($pkey);
            $obj->load();
        ...
        if (empty($pkey) && $frm->flgIsThisForm) {
            $obj = \Prj\Data\Agreement2::getCopy(['verName' => $fields['verName'], 'verId' => $fields['verId']]);
        }
