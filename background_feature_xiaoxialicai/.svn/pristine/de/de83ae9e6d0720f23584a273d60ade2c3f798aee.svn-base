...
class OrdersController extends \Prj\UserCtrl
{
    ...
    public function addAction()
    {
        ...
        if($forbid_buy['forbid'])return $this->returnError($forbid_buy['notice']);
...
/////////////////////////////////////////////////////////TODO
        ...
        if (!$ymdFirstBought) { //首购松泉 //debug  //
            ...
            if (!empty($newVoucherId)) {
                $this->loger->resChanged = array_merge($this->loger->resChanged, [
...
//        $this->loger->resChanged = json_encode([
//            'waresName' => $wares->getField('waresName'),
//            'phone' => $phone,
//            'userId' => $this->user->userId,
//            'contOk' => '订单详情',
