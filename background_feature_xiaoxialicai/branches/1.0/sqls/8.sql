...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='帐号信息表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='帐号名表';
...
insert into db_p2p.tb_config values('dbsql.ver',6) ON DUPLICATE KEY UPDATE v=6;