...
class Wares {
    ...
    const shelf_house = 2000;

    /**
     * 车贷
     */
    const shelf_static_float = 3000;
    const shelf_car = 3000;

    /**
     * 房贷审核
     */
    const shelf_house_review = 4000;

    /**
     * 车贷审核
     */
    const shelf_car_review = 5000;
    ...
    public static $shilfIdName = array(
        ...
        self::shelf_house_review => '房X',
        self::shelf_car_review => '车X',
...
Wares::$shilfIdName[Wares::shelf_house_review] = '房贷宝审核';
Wares::$shilfIdName[Wares::shelf_car_review] = '车贷宝审核';
